...
Wallet operations use the Host `ctx.notifications.show()` service. Source icon/name,
...
Protocol source and hashes are recorded in [notification-sdk-evidence.json](../../wallet/notification-sdk-evidence.json).
